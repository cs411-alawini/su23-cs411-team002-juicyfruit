...
## Query 1 
Write one SQL query to return the GameName, MetacriticRating, and average review score as AvgScore of each Game with an average reviewScore above 0.5. Output the result in ascending order by GameName.
